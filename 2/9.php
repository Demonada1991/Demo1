...
$(document).ready(function () {
 ...
 background-size: cover;
	...
	<body>
			...
			<h1>Name the software development environment that created above games and name the language where its code was written:<h1>
				<img src="../images/ih2/9.jpg" style="width:500px;height:300px;">
