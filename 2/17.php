...
$(document).ready(function () {
 ...
 background-size: cover;
	...
	<body>
		<h1>Beta version of this app was developed for both android and ios devices in july 2010,Name the app:(Virtual keyboard app)<h1>
				<img src="../images/ih2/17.jpg" style="width:300px;height:300px;">
