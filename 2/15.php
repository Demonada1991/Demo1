...
$(document).ready(function () {
 ...
 background-size: cover;
	...
	<body>
			...
			<h1>Name the company which launched the above web        browser.
(hint: India's first web browser)
<h1>
				<img src="../images/ih2/15.jpg" style="width:300px;height:300px;">
