...
$(document).ready(function () {
 ...
 background-size: cover;
	...
	<body>
			...
			<h1>Name the famous mathematical puzzle in the image above that is solved using recursion and iteration techniques.<h1>
				<img src="../images/ih1/1-4.png" style="width:300px;height:300px;">
