...
$(document).ready(function () {
 ...
 background-size: cover;
	...
	<h1>Name the game series made by this company:<h1>
				<img src="../images/ih1/1-16.png" style="width:300px;height:500px;">
